class NavMenu {
    constructor() {
        ...
        this.closeBtn = document.querySelectorAll(".nav_close_btn");
        this.events();
    }
    ...
    events() {
        ...
        this.closeBtn.forEach((item) => {
            let parentId = item.parentElement.parentElement.id;
            let id = parentId.replace(/(nav_)+/g, "");
            item.addEventListener("click", () => {
                this.om_close_nav(id);
            });
        });
    }
    ...
    om_open_nav(x) {
        if (document.getElementById("nav_" + x).style.display == "block") {
            ...
            if (document.getElementById("navbtn_" + x)) {
                document
                    .querySelector("#navbtn_" + x)
                    .getElementsByTagName("i").style.display = "none";
                console.log(
                    document
                        .querySelector("#navbtn_" + x)
    ...
    om_close_nav(x) {
        ...
        if (document.getElementById("navbtn_" + x)) {
            ...
            document
                .getElementById("navbtn_" + x)
                .classList.remove("navbtn_active");
        }
    }
